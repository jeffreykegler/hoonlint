...
hoons/arvo/sys/vane/eyre.hoon ok
...
# hoons/arvo/lib/elem-to-react-json.hoon ok
...
# hoons/arvo/lib/down-jet/parse.hoon ok
...
# hoons/arvo/lib/hood/kiln.hoon ok
...
# hoons/arvo/web/unmark/test.hoon ok
...
sub doTest {
    ...
    if ( $testStatus eq 'ok' ) {
        context_diff;
        Test::More::is_deeply( $stdout, ${$pChildStdin}, "STDOUT of $fileName" );
        return;
    }
