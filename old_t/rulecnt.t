...
my $cmd = ['perl', 'rulecnt.pl'];

my $expectedStdoutFile = 't/util.d/rulecnt.out';
...
Test::More::ok($exitCode eq 0, "exit code of rulecnt.pl is $exitCode");
...
Test::More::ok($stderr eq q{}, "STDERR of rulecnt.pl");

my $stdout = join q{}, @stdout;
eq_or_diff($stdout, ${$pExpectedStdout}, "STDOUT of rulecnt.pl");
