...
my $cmd = ['perl', 'symcnt.pl'];

my $expectedStdoutFile = 't/util.d/symcnt.out';
...
Test::More::ok($exitCode eq 0, "exit code of symcnt.pl is $exitCode");
...
Test::More::ok($stderr eq q{}, "STDERR of symcnt.pl");

my $stdout = join q{}, @stdout;
eq_or_diff($stdout, ${$pExpectedStdout}, "STDOUT of symcnt.pl");
