...
sub doFixedRune {
    ...
    my $glyphLexeme1 = (uc $glyphName1) . '4H';
    my $glyphLexeme2 = (uc $glyphName2) . '4H';
    ...
    # wideBarhep ::= ([|] [-]) (ACE) wide5d (ACE) wide5d
    push @result, $wideLHS . ' ::= ('
    . $glyphLexeme1
    . ' ' . $glyphLexeme2
    . ') [(] ' . (join ' (ACE) ', @wideSamples) . q{ [)]};
    return join "\n", @result, '';
}
...
say join "\n", $dsl_warning, $dsl_main, $glyphAutoRules, $dslAutoRules;
